...
with tab1:
    st.header("1. Upload Audio for generating Notes")
...
with tab2: # <--- This is the new tab for video upload
    st.header("2. Upload Video for for generating Notes")
...
# ---  Tab 3: Upload Transcription File ---
with tab3: # <--- Adjusted tab number
    st.header("3. Upload Existing Transcription File")
    st.info("Upload a text file containing your transcription. Notes will be generated by AI.")
    st.markdown("---")
...
# --- Tab 4: Paste Transcription Text ---
with tab4: # <--- Adjusted tab number
    st.header("4. Paste Transcription Text")
    st.info("Paste your transcription directly into the text area below. Notes will be generated by AI.")
    st.markdown("---")
